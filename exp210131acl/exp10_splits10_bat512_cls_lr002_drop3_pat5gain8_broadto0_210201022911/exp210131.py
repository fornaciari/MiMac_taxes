...
sys.stdout = sys.stderr = log = ut.log(__file__, f"exp{args.nr_exps}_splits{args.splits}_bat{args.big_batsize}_{args.bert_lookup_kind}_lr{str(args.high_learate)[2:]}_drop{str(args.droprob)[2:]}_pat{args.patience}gain{args.min_gain}_broadto0")

...
parser.add_argument("-dir_data", type=str, default='1_preproc/210201023845_to_min20char_contexts/')
# parser.add_argument("-path_xls", type=str, default='0_source/jupyter_xsl_preproc_broadto0_210201020151/all210126.xlsx')
# parser.add_argument("-dir_data", type=str, default='preproc_broadto0/210201021032/')
# parser.add_argument("-path_xls", type=str, default='0_source/jupyter_xsl_preproc_210130170501_min20char/all210126.xlsx')
...
# parser.add_argument("-path_xls", type=str, default='2_preproc_subset/ge2000_210201024514_broadto0/all210126.xlsx')
# parser.add_argument("-dir_data", type=str, default='2_preproc_subset/ge2000_210201024514_broadto0/')
...
parser.add_argument("-min_gain",    type=int,   default = 8)
...
sys.stdout = sys.stderr = log = ut.log(__file__, f"exp{args.nr_exps}_splits{args.splits}_bat{args.big_batsize}_{args.bert_lookup_kind}_lr{str(args.high_learate)[2:]}_drop{str(args.droprob)[2:]}_pat{args.patience}gain{args.min_gain}_contexts")

...
def sendmail(dest=".@gmail.com", sub='nerd-mail', body='nerd-mail'):
    try:
        mitt = "x@"
        mess = MIMEMultipart()
        mess['From'] = mitt
...
def sendslack(text='ping!', blocks=None, attachments=None, thread_ts=None, mrkdwn=True):
    webhook_url = "https://hooks.slack.com/services/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"
